 ...
 * - process the data (locally) - add 0x33333333 to the value of each INT
...
// Variable's initialization
	...
	shared_mem_char_ptr = (alt_u8 *) ( SHARED_ONCHIP_BASE + CPU_3_OFFSET );		//
	//shared_mem_word_ptr = (alt_u16 *) ( SHARED_ONCHIP_BASE + CPU_3_OFFSET );	//
